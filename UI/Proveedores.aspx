<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Proveedores.aspx.cs" MasterPageFile="/base.Master" Inherits="UI.Proveedores" %>
							    ...
							    <div class="panel">
								    ...
								    <div class="panel-body">
									    <div class="form-inline mx-sm-3 mb-2">
                                            <asp:TextBox ID="txtRazonSocialBuscar" class="form-control mr-5" PlaceHolder="Nombre" runat="server"></asp:TextBox>
                ...
                <div class="modal-body">
                    <div class="form form-inline">
                        <div class="form form-group">
                            ...
                            <asp:TextBox ID="txtRazonSocial" class="form-control" runat="server" Width="350px"></asp:TextBox>
                        </div>
                    <div class="form form-inline">
                        <div class="form form-group">
