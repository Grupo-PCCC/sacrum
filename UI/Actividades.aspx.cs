...
namespace UI
{
    public partial class Actividades : System.Web.UI.Page
    {
        ...
        BL_Actividad BL_Actividad = new BL_Actividad();
        Audit L = new Audit();
        int flag = 0;
        ...
        private static class Variables
        {
            ...
            public static int IdActividades;
        }
        ...
        private void CargarLstActividades()
        {
            BL_Actividad objAC = new BL_Actividad();

            lstActividades.DataSource = objAC.ListaActividades();
            lstActividades.DataTextField = "Nombre";
            lstActividades.DataValueField = "Id";
            lstActividades.DataBind();
            //lstActividades.Items.Insert(0, new ListItem("[TODOS]", "0"));
        ...
        public void Enlazar()
        {
            ...
            lblResultado.Text = "Registros: " + Convert.ToString(dgvActividad.Rows.Count);
        }
        ...
        {
            dgvActividad.PageIndex = e.NewPageIndex;
            Enlazar();
        }
        ...
        protected void dgvActividad_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            dgvActividad.PageIndex = e.NewPageIndex;
            Enlazar();
        }

        protected void lstActividades_SelectedIndexChanged(object sender, EventArgs e)
        {
