                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 ml-0">
                                <asp:Button ID="btnNuevo" CssClass="btn btn-primary" runat="server" Text="Nuevo movimiento" />
                            </div>
                            <%--Agregar movimiento--%>
							    ...
							    <div class="panel">
								    ...
								    <div class="panel-body">
									    <div class="form-inline mx-sm-3 mb-2">
                                            ...
                                            <div class="form form-group">
                                                <asp:Button ID="Button1" runat="server" class="btn btn-secondary" Text="Buscar" />
                        ...
                        <asp:GridView ID="dgvMovimientos" runat="server" class="table table-striped text-center" CellPadding="4" AutoGenerateColumns="False" DataKeyNames="Id" CellSpacing="2"  AllowPaging="true">
                            <Columns>
